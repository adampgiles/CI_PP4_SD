...
urlpatterns = [
    ...
    path('confirmdelete/<int:developer_id>/', views.confirm_delete_developer, name='confirm_delete_developer'),
    ...
    path('confirmdeletepost/<int:post_id>/', views.confirm_delete_post, name='confirm_delete_post'),
